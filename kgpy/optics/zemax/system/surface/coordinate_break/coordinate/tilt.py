...
class Tilt(surface.coordinate.Tilt['coordinate.TiltDecenter']):
    ...
    def _x_setter(self, value: float):
        self._composite._composite.lde_row.SurfaceData.TiltAbout_X = value

    def _y_setter(self, value: float):
        self._composite._composite.lde_row.SurfaceData.TiltAbout_Y = value

    def _z_setter(self, value: float):
        self._composite._composite.lde_row.SurfaceData.TiltAbout_Z = value
