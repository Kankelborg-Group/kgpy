...
#     object_surface: surfaces.Surface = dataclasses.field(default_factory=surfaces.Surface)
#     surface_sequence: surfaces.SurfaceList = dataclasses.field(default_factory=surfaces.SurfaceList)
...
#     baffles_blank: baffles.BaffleList = dataclasses.field(default_factory=baffles.BaffleList)
#     baffles_hull_axes: typ.Optional[typ.Tuple[int, ...]] = None
#     breadboard: typ.Optional[breadboards.Breadboard] = None
...
#
#     @property
#     def surfaces_all(self) -> surfaces.SurfaceList:
#         surface_sequence = self.surface_sequence.copy()
#         surface_sequence.transform = self.transform_all
#         return surfaces.SurfaceList([self.object_surface, surface_sequence])
#
#     @property
#     def field_stop(self: SystemT) -> surfaces.Surface:
...
#
#     @property
#     def pupil_stop(self: SystemT) -> surfaces.Surface:
#         for surf in self.surfaces_all.flat_global_iter:
...
#         return self.rays_input.wavelength
#
...
#
#     @property
#     def baffle_lofts(self) -> typ.Dict[int, typ.Tuple[surfaces.Surface, surfaces.Surface]]:
#         lofts = {}
#         for surf in self.surfaces_all.flat_global_iter:
...
#
#     @property
#     def baffles(self) -> baffles.BaffleList:
...
#     def calc_baffles(
#             self,
#             baffles_blank: baffles.BaffleList,
...
#
#             surfaces_subsystem = surface.SurfaceList()
