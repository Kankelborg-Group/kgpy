...
class Aperture:
    ...
    def promote_to_zmx(self, surf: 'optics.ZmxSurface', attr_str: str
        ...
        a = kgpy.optics.zemax.system.configuration.surface.Aperture(surf, attr_str)
...
class Rectangular(Aperture):
    ...
    def promote_to_zmx(self, surf: 'optics.ZmxSurface', attr_str: str
        ...
        a = kgpy.optics.zemax.system.configuration.surface.aperture.Rectangular(self.half_width_x, self.half_width_y, surf, attr_str)
...
class Circular(Aperture):
    ...
    def promote_to_zmx(self, surf: 'optics.ZmxSurface', attr_str: str
        ...
        a = kgpy.optics.zemax.system.configuration.surface.aperture.Circular(self.min_radius, self.max_radius, surf, attr_str)
...
class Spider(Aperture):
    ...
    def promote_to_zmx(self, surf: 'optics.ZmxSurface', attr_str: str
        ...
        a = kgpy.optics.zemax.system.configuration.surface.aperture.Spider(self.arm_width, self.num_arms, surf, attr_str)
